  ...
  return (
    <div className="flex items-start gap-4 rounded-xl border border-slate-200 bg-white p-5">
      ...
      <div>
        ...
        <p className="mt-1 whitespace-pre-line text-[13px] font-bold leading-[1.8] text-slate-500">
          {merit.desc}
        </p>
      </div>
    </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="whitespace-pre-line text-left text-[12.5px] font-bold leading-[1.6] text-slate-500">
                      {merit.desc}
                    </p>
                  </div>
                </div>
